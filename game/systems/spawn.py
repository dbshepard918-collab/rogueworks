...
SCALING = [
    ...
    [2,     1.06, 1.05, 0, 0.060, 0.60],
    [3,     1.12, 1.10, 0, 0.080, 0.65],   # r60: smooth curve, no sudden spike
    [4,     1.20, 1.16, 1, 0.110, 0.70],
    [5,     1.30, 1.23, 1, 0.150, 0.75],
    [6,     1.42, 1.31, 1, 0.180, 0.75],
    [7,     1.55, 1.40, 1, 0.210, 0.75],
    [8,     1.70, 1.50, 1, 0.240, 0.75],
    [9,     1.86, 1.61, 2, 0.260, 0.75],
    [10,    2.04, 1.73, 2, 0.280, 0.75],
    [11,    2.24, 1.86, 2, 0.290, 0.75],
    [12,    2.46, 2.00, 2, 0.300, 0.75],
    [13,    2.70, 2.15, 2, 0.300, 0.75],
    [14,    2.96, 2.31, 2, 0.300, 0.75],
    [15,    3.24, 2.48, 3, 0.300, 1.00],   # final boss floor — guaranteed guardian
]
